    ...
    EH: EventHandler
{
    ...
    /// User-defined functions called by the physics engines during one timestep in order to
    /// customize its behavior.
    pub physics_hooks: PH,
    /// Responsible for handling events generated by the physics engine.
